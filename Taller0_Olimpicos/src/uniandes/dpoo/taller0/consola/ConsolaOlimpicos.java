...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisAtleta()
	{
		...
		String elPais = calculadora.Atletapais(nombreAtleta); 
		if (elPais == null)
		{
			System.out.println("No se encontr� un atleta llamado " + nombreAtleta);
		}
		else {
			System.out.println("\n" + "El pa�s que representa " + nombreAtleta + " es: "  + elPais + "\n");
